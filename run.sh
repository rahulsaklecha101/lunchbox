...
function start_infra() {
    echo "Starting mongodb rabbitmq setup-vault config-server service-registry hystrix-dashboard...."
    docker-compose -f ${dc_main} up --build --force-recreate -d mongodb rabbitmq setup-vault config-server service-registry hystrix-dashboard
    docker-compose -f ${dc_main} logs -f
}
